...
const NearbyDoc = () => {
  ...
  const handleFindDoc = (google_location) => {
    // Redirect to the "/doctor-appoint" page
    openLinkInNewTab(google_location);
  };
              ...
              {filteredDoctors.map((doctor) => (
                <div className="doctor-card" key={doctor._id}>
                  ...
                  <div className="doctor-details">
                    ...
                    <button className="book-appointment-btn" onClick={() =>handleFindDoc(doctor.google_location)}>Find Location</button>
                  </div>
                </div>
              ))}
            </div>
